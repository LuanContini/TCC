...
class Agendamento(db.Model):
    ...
    status = db.Column(db.String(2), server_default='PE')  # Valor padrão
    ...
    idPaciente = db.Column(db.Integer, db.ForeignKey('paciente.idPaciente', onupdate='RESTRICT', ondelete='CASCADE'), nullable=False)  # NOVO CAMPO
    ...
    paciente = db.relationship('Paciente', backref='agendamentos')  # NOVO RELATIONSHIP
    ...
    def __repr__(self):
        return f'<Agendamento {self.codiAgen}>'